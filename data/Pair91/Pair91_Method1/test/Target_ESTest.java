...
public class Target_ESTest extends Target_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: ClassCastException");
         ...
         //
         // class Target cannot be cast to class java.lang.String (Target is in unnamed module of loader org.evosuite.instrumentation.InstrumentingClassLoader @5142e1c7; java.lang.String is in module java.base of loader 'bootstrap')
         //
         verifyException("Target", e);
      }
  }
  ...
  public void test3()  throws Throwable  {
      Target target0 = new Target();
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("]`lUUz@");
      String string0 = target0.__target__(linkedList0);
      assertEquals("]`lUUz@ ", string0);
  }
